...
/* this took so long to work out, I kept getting confused with 'volume' and 'setVolume' and 'media.volume'. 
though, upon analysing the other functions I worked it out.

Created an event listener to the input named "volume" function,

"change" means when the user changes the position of the slider.
and "setVolume" is the name of the new function that is described in the line that follows.

the new function "function setVolume" takes the "media's aka video's" volume equal to the volSlider value/position. */ 
